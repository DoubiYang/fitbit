...
import { handleCurrentMealDraftAiSuggestions } from '../../../../../../src/server/meals/http';
...
export async function POST(request: Request, context: { params: Promise<{ id: string }> }): Promise<Response> {
  ...
  return handleCurrentMealDraftAiSuggestions(request, (await context.params).id, { config, store: deps.store });
}
